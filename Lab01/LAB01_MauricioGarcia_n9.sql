...
/*7. Crear un reporte para el departamento de Recursos Humanos que muestre el N° de Departamento,
Apellidos, Puestos de todos los empleados en el departamento ‘Executive’. */

SELECT DEPARTMENT_ID, LAST_NAME, JOB_ID
FROM HR.EMPLOYEES
WHERE DEPARTMENT_ID = (SELECT DEPARTMENT_ID FROM HR.DEPARTMENT WHERE DEPARTMENT_NAME= 'Executive');

/*8. Modificar la consulta del ítem 4.3 para que adicionalmente se muestro solo a los empleados que tengan
